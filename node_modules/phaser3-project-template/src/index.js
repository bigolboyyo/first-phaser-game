...
function preload (){
    ...
    load.spritesheet("katCoin", "assets/katCoin.png", {frameWidth: 32, frameHeight: 32})
...
function create (){
    ...
    katCoin = spriteCreation(100, 100, "katCoin", physics, platforms, katCoinMovement).play("coinIdle")
